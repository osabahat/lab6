...
public class GameRuleCardsDAL   {
	...
	// updates the rule if you decide you want to change it 

	public static GameRuleCardsDomainModel updateRule(GameRuleCardsDomainModel grc){

	Session session = HibernateUtil.getSessionFactory().openSession();

	Transaction tx = null;

	GameRuleCardsDomainModel grcGet = null;
